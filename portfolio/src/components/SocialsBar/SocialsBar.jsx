  ...
  return (
    <div className={`flex flex-row gap-10 justify-center items-center`}>
        <a href="https://github.com/elnukakujo" target="_blank" rel="noreferrer">
            <img src={githubLogo} alt="Github Logo" className='interact logo' style={{height: `calc(${size}*0.25rem)`}}/>
        </a>
        <a href="https://www.linkedin.com/in/no%C3%A9-jager-2b4866236/" target="_blank" rel="noreferrer">
            <img src={linkedinLogo} alt="Linkedin Logo" className='interact logo' style={{height: `calc(${size}*0.25rem)`}}/>
        </a>
        <a href="mailto:noe.p.jager@gmail.com" target="_blank" rel="noreferrer">
            <img src={gmailLogo} alt="Gmail Logo" className='interact logo' style={{height: `calc(${size}*0.25rem)`}}/>
        </a>
    </div>
    );
}
