        ...
        <div className="about-me-section">
            ...
            <div className="about-me-section__content_and_cta">
                ...
                <div className="about-me-section__cta">
                    <a onClick={() => handleNavigate("aboutme", "education")} className="about-me-section__cta-button">
                        <FontAwesomeIcon icon={faBookOpen} />
                        <p>Education</p>
                    </a>
                    <a onClick={() => handleNavigate("aboutme", "experience")} className="about-me-section__cta-button">
                        <FontAwesomeIcon icon={faBriefcase} />
                        <p>Experience</p>
                    </a>
                    <a onClick={() => handleNavigate("aboutme", "life")} className="about-me-section__cta-button">
                        <FontAwesomeIcon icon={faCircleInfo} />
                        <p>Not Enough?</p>
                    </a>
                    <a onClick={() => handleNavigate("", "contact-me-section")} className="about-me-section__cta-button">
